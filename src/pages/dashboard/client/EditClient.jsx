...
const EditClient = () => {
    ...
    const { register, handleSubmit, formState: { errors } } = useForm({
        defaultValues: {
            // Dummy Data Default Values
            name: 'PT. Telkom Indonesia',
            category: 'BUMN',
            trustedSeq: 1,
            priority: 'Active',
            status: 'Active',
            image: 'https://via.placeholder.com/150', // Gambar placeholder sebagai data dummy
            // priority: 'Active',
            // status: 'Active',
        }
    });
            ...
            <Card>
                ...
                <Card.Body>
                    <Form onSubmit={handleSubmit(handleShow)}>
                        ...
                        <Row>
                            <ButtonFormBottom isMobile={isMobile} navigateCancelPath='../client' typeButton={"edit"} />
                        </Row>
                    </Form>
                </Card.Body>
            </Card>
