...
const ExpertiseForm = ({ formSubmit, formData, setFormData, show, setShow, isError, setIsError, errorMessage, setErrorMessage,
    isJustDetail, typeFormButton, setShowDetail, setUploadedImage, expertiseCategory }) => {
                    ...
                    <Col md='6' sm='12'>
                        <Form.Group controlId="category">
                            ...
                            <Form.Select aria-label="Select category"
                                ...
                                isInvalid={!!errors.category} defaultValue={formData.category}
                            >
                                <option value='' disabled>Category</option>
                                {expertiseCategory.map((category, index) => (
...
ExpertiseForm.propTypes = {
    ...
    expertiseCategory: PropTypes.array
}
