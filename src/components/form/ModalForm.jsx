...
const ModalForm = ({ show, handleClose, page, data, buttonType, formSubmit, isError, errorMessage }) => {
    return (
        <Modal show={show} onHide={handleClose} centered aria-labelledby="contained-modal-title-vcenter" style={{ '--bs-modal-width': '400px' }}>
            ...
            <Stack className="px-4 d-flex justify-content-center text-center">
                <Image src={buttonType === 'delete' || isError ? iconDelete : buttonType === 'edit' ? iconEdit : icon} height='100px' />
